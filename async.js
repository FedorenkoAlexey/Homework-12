...
users$.subscribe({
    next: function () {
        ...
        posts$.subscribe({
            ...
            error: function (err) { return console.error("something wrong: " + err); },
            complete: function () { return console.log("done-post"); }
        });
    },
    error: function (err) { return console.error("something wrong occurred: " + err); },
    complete: function () { return console.log("done-users"); }
});
